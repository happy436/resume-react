...
import { UilInstagram, UilPhone , UilTelegramAlt, UilEnvelope } from '@iconscout/react-unicons'
...
export const ContactMe = (props) => {
    ...
    return (
        <section className={v.section}>
            <h2 className={v.section__title}>{language === 1 ? "Contacts" : "Контакты"}</h2>
            <span className={v.section__subtitle}>{language === 1 ? "Get in touch" : "Связатся"}</span>
            <div>
