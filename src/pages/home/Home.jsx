...
export const Home = props => {
    const { language, baseURL } = useContext(Context)
    return (
                ...
                <div className={`${s.content} ${v.grid}`}>
                    ...
                    <div className={s.data}>
                        <h1 className={s.title}>
                            {language === 1 ? "Hi, i'm Oleg" : "Привет, я Олег"}
                        </h1>
                        ...
                        <p className={s.description}>
                            {language === 1
                                ? "Beginner level experience in web"
                                : "Опыт работы в вебе на начальном уровне"}
                        </p>
                        <NavLink
                        ...
                        >
                            ...
                            <UilMessage className={v.button__icon} />
                        </NavLink>
                    </div>
                </div>
            </div>
